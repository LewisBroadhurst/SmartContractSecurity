...
[Q16]: The impact of data location of [b]reference types[/b] on assignments is
...
A. (B): Are possible but prevented by compiler added checks (version dependent)
...
A. (A): Are user-defined type, (C): Can contain or be contained in arrays and mappings
